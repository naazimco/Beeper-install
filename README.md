...
3. Open Terminal, then run these commands:
```
cd ~/Downloads
chmod +x Beeper_macOS_install.command
./Beeper_macOS_install.command
```
...
This will also keep a backup of the previous version of Beeper in case the new version introduces any issues.
